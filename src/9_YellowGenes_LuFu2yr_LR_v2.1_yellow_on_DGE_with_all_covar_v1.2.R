...
#3) Read LungMetaData4Hiv for TV (Tidal volume at 24 months, i.e., 2 year)
...
for (geneIndex in c(1:totalGenes)){
	...
	outputFileName <- paste("WGCNA/YellowHubGenes191/LuFu_TV_2yr_lm_output_4_", geneNameWithExt, sep="")

	#sink(outputFileName)
	#print(summary(tvBlackHubGeneLm))
	#sink()  # returns output to the console

	geneNameWithExt2 <- paste(geneName,"_with_covar.csv",sep="")
	outputFileName2 <- paste("WGCNA/YellowHubGenes191/LuFu_TV_2yr_lm_CoefMat_4_", geneNameWithExt2, sep="")
...
outputFileNameAll <- paste("WGCNA/YellowHubGenes191/LuFu_TV_2yr_lm_CoefMat_4_", "All_genes_with_covar.csv", sep="")
