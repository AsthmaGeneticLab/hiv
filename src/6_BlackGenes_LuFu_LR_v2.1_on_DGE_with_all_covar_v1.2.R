...
head(sampleWiseBlackHubGeneExpr2$C8orf59)
...
for (geneIndex in c(1:totalGenes)){
	...
	outputFileName <- paste("WGCNA/BlackHubGenes177/LuFu_TV_lm_output_4_", geneNameWithExt, sep="")

	geneNameWithExt2 <- paste(geneName,"_with_covar.csv",sep="")
	outputFileName2 <- paste("WGCNA/BlackHubGenes177/LuFu_TV_lm_CoefMat_4_", geneNameWithExt2, sep="")
...
outputFileNameAll <- paste("WGCNA/BlackHubGenes177/LuFu_TV_lm_CoefMat_4_", "All_genes_with_covar.csv", sep="")
